# IWM Intraday Downtrend Continuation
...
IWM exhibits high sensitivity to structural breakdowns. A gap-down that invalidates the Middle Bollinger support while trading below both the 50-day and 200-day SMAs signals a loss of institutional support and high probability of continued capitulation toward the Lower Bollinger band. Geopolitical escalation acts as a powerful catalyst for this setup, accelerating the move as small-caps are often the first to be shed in a "risk-off" environment.
...
- Reclamation of VWAP or the 50-day SMA invalidates the intraday momentum thesis.
- Broad market (SPY/QQQ) decoupling can stall the move even if technicals are bearish.
