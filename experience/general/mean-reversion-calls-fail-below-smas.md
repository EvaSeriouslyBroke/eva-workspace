...
- **BAC (Financial):** Failed twice (-8.3% and -20.6% losses) buying calls below both SMAs during financial sector weakness
- **HD (Cyclical):** Failed (-2.9% from entry to exit) buying calls in cyclical downturn below both SMAs with macro headwinds

The pattern appears consistent across sectors: when below both SMAs, "oversold" is a warning, not a signal.

## Evidence

### Summary
2 supporting observations across 2 different tickers (BAC, HD). Both mean reversion call attempts failed with losses when entry occurred below both SMAs during sustained downtrends. Cross-ticker consistency suggests this is a robust technical pattern.
...
- 2026-03-09 [paper] [supporting] [bear] [dte-medium]: HD 360C Aug-21 entry at 357.86 below both 20 and 50 SMAs during housing/cyclical downturn. Exited after recognizing macro-driven structural decline. Stock dropped -2.9% from entry to exit, thesis invalidated.
